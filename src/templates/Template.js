...
import github from '@images/github.png';//cargar imageness
import twitter from '@images/twitter.png';//cargar imageness
import instagram from '@images/instagram.png';//cargar imageness
